...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_60_with_macro(
    RGB_VAD, RGB_VAI,  KC_EQL,           KC_1,   KC_2,     KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS,               KC_EQL, KC_NO,  KC_NO, \
    ...
    TG(_PLEB),RGB_TOG, KC_CAPS,          LWIN_T(KC_LBRC),LWIN_T(KC_RBRC),LALT_T(KC_BSPC),LT(_FN1,KC_SPC), LT(_FN1, KC_ENT), RALT_T(KC_BSPC), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO
  ),
