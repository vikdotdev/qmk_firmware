...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_MAIN] = LAYOUT_5x6(
     KC_1   , KC_2  , KC_3  , KC_4  , KC_5  , KC_6,                 KC_7, KC_8, KC_9,    KC_0,   KC_GRV,  RESET,
     ...
     OSM_LS,  KC_Z  , KC_X  , KC_C  , KC_V  , KC_B,                 KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, OSM_LS,
                      KC_LBRC, KC_RBRC,                                         KC_MINS, KC_EQL,
                                      OSL_NUM,                            OSM_LC,
                                      SP_SPC,KC_UNDS,          TG_MOU,    TS_ENT,
                                      OSM_LA,KC_CAPS,          OSM_WIN,   OSM_LA
  ),
  [_SIDE] = LAYOUT_5x6(
     _______,_______,_______,_______,_______,_______,                      TG_GAME,TG_CSGO,_______,_______,_______,KC_NO,
     _______,_______,_______,C_TAB_B,C_TAB_F,LW_SPC ,                      AU_TOG ,C_LBRC ,C_RBRC ,KC_NO  ,KC_PSCR,KC_PIPE,
     KC_MUTE,KC_VOLD,KC_VOLU,KC_BSPC,KC_DEL ,KC_ENT ,                      KC_LEFT,KC_DOWN,KC_UP  ,KC_RGHT,KC_COLN,KC_DQUO,
     KC_MPLY,KC_MPRV,KC_MNXT,A_TAB_B,A_TAB_F,OSL_FN ,                      _______,_______,KC_LABK,KC_RABK,KC_QUES,_______,
                    KC_LCBR,KC_RCBR,                                                       KC_UNDS,KC_PLUS,
                                     _______,                                      _______,
  ...
  [_GAME] = LAYOUT_5x6(
     ...
     KC_LCTL, KC_Z  , KC_X  , KC_C  , KC_V  , KC_B,                 KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, OSM_LS,
                      KC_LBRC, KC_RBRC,                                         KC_MINS, KC_EQL,
                                      MO(_SIDE),                          OSM_LC,
                                      KC_SPC,KC_UNDS,          TG_MOU,    TS_ENT,
                                      OSM_LA,TG_GAME,          OSM_WIN,   OSM_LA
  ),
  [_CSGO] = LAYOUT_5x6(
     KC_GRV, KC_5   , KC_1  , KC_2  , KC_3  , KC_4,                 KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
     KC_T,   KC_TAB,  KC_Q  , KC_W  , KC_E  , KC_R,                 KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
     KC_G,   KC_LSFT, KC_A  , KC_S  , KC_D  , KC_F,                 KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
     KC_B,   KC_LCTL, KC_Z  , KC_X  , KC_C  , KC_V,                 KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
                      KC_NO, KC_NO,                                               KC_NO, KC_NO,
                                      MO(_SIDE),                          KC_NO,
                                      KC_SPC ,KC_ESC,            KC_NO,   KC_NO,
                                      KC_LALT,TG_CSGO,           KC_NO,   KC_NO
  ),
};
